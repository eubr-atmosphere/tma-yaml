# TMA-Deployment
In this directory is presented `tma_deployment_without_ceph.yaml` file. This file deploys all components of TMA platform without `Ceph` block storage solution.
